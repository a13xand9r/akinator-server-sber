...
export const runAppHandler: SaluteHandler = ({ req, res }) => {
  if (req.request.payload.character.appeal === 'official'){
    ...
    res.appendBubble('Здравствуйте! Здесь я буду в роли Джина Акина\'тора. Я могу угадать любого персонажа, которого вы загадали и помогу в изучении английского. Давайте играть и учить английский вместе.')
  }
  ...
  res.appendBubble('Привет! Здесь я буду в роли Джина Акина\'тора. Я могу угадать любого персонажа, которого ты загадал и помогу в изучении английского. Давай играть и учить английский вместе.')
}
